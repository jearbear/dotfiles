...
local on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', '<C-k>', '<cmd>lua vim.diagnostic.goto_prev({float = { border = "single" }, wrap = false})<CR>', opts)
    buf_set_keymap('n', '<C-j>', '<cmd>lua vim.diagnostic.goto_next({float = { border = "single" }, wrap = false})<CR>', opts)
